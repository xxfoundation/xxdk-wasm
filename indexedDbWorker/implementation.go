...
type wasmModel struct {
	...
	receivedMessageCB indexedDb.MessageReceivedCallback
...
func (w *wasmModel) receiveHelper(newMessage *Message, isUpdate bool) (uint64,
	...
	// FIXME: The error needs to be checked here
...
func (w *wasmModel) GetMessage(
	...
	if lookupResult.ParentMessageID != nil {
		parentMsgId, err =
			cryptoChannel.UnmarshalMessageID(lookupResult.ParentMessageID)
		if err != nil {
			return channels.ModelMessage{}, err
		}
	}
