...
func GenerateChannelIdentity(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		pi, err := bindings.GenerateChannelIdentity(seed)
		if err != nil {
		...
		resolve(utils.CopyBytesToJS(pi))
		return
	})
}
...
func ConstructIdentity(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		if exists {
			resolve(utils.CopyBytesToJS(identityObj.([]byte)))
			return
		}

		identity, err := bindings.ConstructIdentity(pubKey, seed)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func NewChannelsManagerWithIndexedDb(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		resolve(newChannelsManagerWithIndexedDb(cmixID, wasmJsPath, privateIdentity,
...
func newChannelsManagerWithIndexedDb(cmixID int, wasmJsPath string,
	...
	cm, err := bindings.NewChannelsManagerGoEventModel(cmixID,
		...
		channelsCbs)
	if err != nil {
		jww.FATAL.Panicf("[CH] Failed to create channels manager: %+v", err)
	}
...
func LoadChannelsManagerWithIndexedDb(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		resolve(loadChannelsManagerWithIndexedDb(cmixID, wasmJsPath, storageTag,
...
func loadChannelsManagerWithIndexedDb(cmixID int, wasmJsPath, storageTag string,
	...
	cm, err := bindings.LoadChannelsManagerGoEventModel(
		...
		channelsCbs)
	if err != nil {
		jww.FATAL.Panicf("[CH] Failed to load channels manager: %+v", err)
	}
	return newChannelsManagerJS(cm)
}
...
func DecodePublicURL(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		c, err := bindings.DecodePublicURL(url)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func DecodePrivateURL(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		c, err := bindings.DecodePrivateURL(url, password)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func GetChannelJSON(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		c, err := bindings.GetChannelJSON(url)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func GetChannelInfo(_ js.Value, args []js.Value) any {
	// ✅ Parse ALL args BEFORE CreatePromise to avoid race conditions
	prettyPrint := args[0].String()

	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		ci, err := bindings.GetChannelInfo(prettyPrint)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) GenerateChannel(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		prettyPrint, err := cm.api.GenerateChannel(name, description, privacyLevel)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
//	}
func (cm *ChannelsManager) GetChannels(_ js.Value, args []js.Value) any {
	// No args to parse
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		resolve(utils.CopyBytesToJS(channelList))
		return
	})
}
...
func (cm *ChannelsManager) GetShareURL(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		resolve(utils.CopyBytesToJS(su))
		return
	})
}
...
func GetShareUrlType(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		level, err := bindings.GetShareUrlType(url)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) GetIdentity(_ js.Value, args []js.Value) any {
	// No args to parse
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
...
func (cm *ChannelsManager) ExportPrivateIdentity(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		i, err := cm.api.ExportPrivateIdentity(password)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) SetNickname(_ js.Value, args []js.Value) any {
	// ✅ Parse ALL args BEFORE CreatePromise to avoid race conditions
	nickname := args[0].String()
	channelIdBytes := utils.CopyBytesToGo(args[1])

	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		err := cm.api.SetNickname(nickname, channelIdBytes)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) DeleteNickname(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		err := cm.api.DeleteNickname(channelIdBytes)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) GetNickname(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		nickname, err := cm.api.GetNickname(channelIdBytes)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func IsNicknameValid(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		err := bindings.IsNicknameValid(nickname)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) GetMutedUsers(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		...
		resolve(utils.CopyBytesToJS(mutedUsers))
		return
	})
}
...
func (cm *ChannelsManager) IsChannelAdmin(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		isAdmin, err := cm.api.IsChannelAdmin(channelIDBytes)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cm *ChannelsManager) ExportChannelAdminKey(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		pk, err := cm.api.ExportChannelAdminKey(channelIDBytes, encryptionPassword)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
		...
		resolve(utils.CopyBytesToJS(pk))
		return
	})
}
...
func (cm *ChannelsManager) DeleteChannelAdminKey(_ js.Value, args []js.Value) any {
	...
	return utils.CreatePromise(func(resolve, reject func(...any) js.Value) {
		err := cm.api.DeleteChannelAdminKey(channelIDBytes)
		if err != nil {
			errorConstructor := js.Global().Get("Error")
			errorObject := errorConstructor.New(err.Error())
			reject(errorObject)
...
func (cmrCB *channelMessageReceptionCallback) Callback(
	...
	uuid := cmrCB.callback(utils.CopyBytesToJS(receivedChannelMessageReport), errVal)
