...
func newRemoteKvJS(api *bindings.RemoteKV) map[string]any {
	...
	rkvMap := map[string]any{
		"Get":                      utils.SafeFunc(rkv.Get),
		"Delete":                   utils.SafeFunc(rkv.Delete),
		"Set":                      utils.SafeFunc(rkv.Set),
		"GetPrefix":                utils.SafeFunc(rkv.GetPrefix),
		"HasPrefix":                utils.SafeFunc(rkv.HasPrefix),
		"Prefix":                   utils.SafeFunc(rkv.Prefix),
		"Root":                     utils.SafeFunc(rkv.Root),
		"IsMemStore":               utils.SafeFunc(rkv.IsMemStore),
		"GetFullKey":               utils.SafeFunc(rkv.GetFullKey),
		"StoreMapElement":          utils.SafeFunc(rkv.StoreMapElement),
		"StoreMap":                 utils.SafeFunc(rkv.StoreMap),
		"DeleteMapElement":         utils.SafeFunc(rkv.DeleteMapElement),
		"GetMap":                   utils.SafeFunc(rkv.GetMap),
		"GetMapElement":            utils.SafeFunc(rkv.GetMapElement),
		"ListenOnRemoteKey":        rkv.ListenOnRemoteKey,
		"ListenOnRemoteMap":        rkv.ListenOnRemoteMap,
		"GetAllRemoteKeyListeners": js.FuncOf(rkv.GetAllRemoteKeyListeners),
		"GetRemoteKeyListeners":    js.FuncOf(rkv.GetRemoteKeyListeners),
		"DeleteRemoteKeyListener":  utils.SafeFunc(rkv.DeleteRemoteKeyListener),
		"GetAllRemoteMapListeners": js.FuncOf(rkv.GetAllRemoteMapListeners),
		"GetRemoteMapListeners":    js.FuncOf(rkv.GetRemoteMapListeners),
		"DeleteRemoteMapListener":  utils.SafeFunc(rkv.DeleteRemoteMapListener),
	}
	return rkvMap
}
...
func (r *RemoteKV) Get(this js.Value, args []js.Value) (any, error) {
	key := args[0].String()
...
//   - Rejected with an access error. Note: File does not exist errors
//     are returned whent key is not set.
func (r *RemoteKV) Delete(this js.Value, args []js.Value) (any, error) {
	key := args[0].String()
	version := int64(args[1].Int())
...
func (r *RemoteKV) Set(this js.Value, args []js.Value) (any, error) {
	key := args[0].String()
...
func (r *RemoteKV) GetPrefix(this js.Value, args []js.Value) (any, error) {
...
func (r *RemoteKV) HasPrefix(this js.Value, args []js.Value) (any, error) {
...
func (r *RemoteKV) Prefix(this js.Value, args []js.Value) (any, error) {
	prefix := args[0].String()
...
func (r *RemoteKV) Root(this js.Value, args []js.Value) (any, error) {
...
func (r *RemoteKV) StoreMapElement(this js.Value, args []js.Value) (any, error) {
...
//
// Returns a promise with an error if any
func (r *RemoteKV) StoreMap(this js.Value, args []js.Value) (any, error) {
	mapName := args[0].String()
...
//	{"Version":1,"Timestamp":"2023-05-13T00:50:03.889192694Z",
//	"Data":"bm90IHVwZ3JhZGVk"}
func (r *RemoteKV) DeleteMapElement(this js.Value, args []js.Value) (any, error) {
	mapName := args[0].String()
	elementKey := args[1].String()
	version := int64(args[2].Int())
	deleted, err := r.api.DeleteMapElement(mapName, elementKey, version)
	if err != nil {
		return nil, err
	}
...
//	{"elementKey": {"Version":1,"Timestamp":"2023-05-13T00:50:03.889192694Z",
//	"Data":"bm90IHVwZ3JhZGVk"}}
func (r *RemoteKV) GetMap(this js.Value, args []js.Value) (any, error) {
	mapName := args[0].String()
	version := int64(args[1].Int())
...
//	{"Version":1,"Timestamp":"2023-05-13T00:50:03.889192694Z",
//	"Data":"bm90IHVwZ3JhZGVk"}
func (r *RemoteKV) GetMapElement(this js.Value, args []js.Value) (any, error) {
	mapName := args[0].String()
	elementKey := args[1].String()
	version := int64(args[2].Int())
	element, err := r.api.GetMapElement(mapName, elementKey, version)
	if err != nil {
		return nil, err
	}
...
func (r *RemoteKV) DeleteRemoteKeyListener(this js.Value, args []js.Value) (any, error) {
	key := args[0].String()
	id := args[1].Int()
...
//   - args[1] - the id of the listener
func (r *RemoteKV) DeleteRemoteMapListener(this js.Value, args []js.Value) (any, error) {
	mapName := args[0].String()
	id := args[1].Int()
